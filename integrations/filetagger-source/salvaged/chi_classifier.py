...
CHI_FACTORS = {
    'G': {
        ...
        'keywords': [
            ...
            'common grace', 'floor', 'sustaining', 'negentropic',
            'g > 0', 'persistent source', 'external source', 'pump',
            'input', 'dependency', 'sovereign', 'sustain', 'provision',
            'unearned', 'gravity', 'einstein', 'curved', 'warped',
            'geometry', 'manifold', 'tensor', 'g term', 'grace term',
            'lower bound', 'minimum coherence', 'baseline',
        ],
    ...
    'E': {
        ...
        'keywords': [
            ...
            'evidence', 'data', 'empirical', 'measurement', 'measured',
            'statistical', 'correlation', 'r squared', 'p value',
            'sigma', 'regression', 'fit', 'curve fit', 'analysis',
            'experiment', 'observation', 'verify', 'verification',
            'falsify', 'falsification', 'testable', 'prediction',
            'hypothesis', 'claim', 'proof', 'demonstrate', 'shown',
            'result', 'finding', 'dataset', 'data point', 'outlier',
        ],
    ...
    'S': {
        ...
        'keywords': [
            ...
            'decoherence', 'exponential decay', 'asymptote', 'floor',
            'phase transition', 'coupling constant', 'dissipation',
            'relaxation', 'equilibrium', 'thermal', 'irreversible',
            'arrow of time', 'loss', 'noise', 'drift', 'degradation',
            'tau', 'time constant', 'half life', 'decay rate',
            'driven dissipative', 'damping', 'attenuation',
        ],
    ...
    'T': {
        ...
        'keywords': [
            ...
            'lifespan', 'longevity', 'chronology', 'genealogy',
            'patriarch', 'generation', 'years', 'centuries',
            'millennium', 'persistence', 'duration', 'epoch',
            'retrocausal', 'delayed choice', 'pre flood', 'post flood',
            'biblical time', 'creation', 'history', 'ancient',
        ],
    ...
    'K': {
        ...
        'keywords': [
            ...
            'compression', 'compressible', 'lossless', 'density',
            'information theory', 'entropy', 'mutual information',
            'redundancy', 'error correction', 'code', 'cipher',
            'meaning', 'semantic', 'syntax', 'language', 'definition',
            'concept', 'abstraction', 'model', 'equation', 'formula',
            'mathematical', 'notation', 'variable', 'parameter',
        ],
    ...
    'F': {
        ...
        'keywords': [
            ...
            'cross domain', 'cross-domain', 'isomorphism', 'bridge',
            'structural', 'connection', 'binding', 'mapping',
            'correspondence', 'dual', 'projection', 'analogy',
            'homomorphism', 'functor', 'category', 'transformation',
            'between', 'across', 'domains', 'physics theology',
            'convergence', 'parallel', 'same equation', 'identical',
        ],
